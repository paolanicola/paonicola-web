          ...
          <div className='ayuda text-center'>
            ...
            <div className='lista-ayuda'>
              <ul className={animate ? 'two animate fadeLeft' : 'two animate fadeOut'}>
                ...
                <li className={animate ? 'four animate fadeIn' : 'two animate fadeOut'}>
                  <img className='item-img-tic' src={tic} alt='Mi metodologia' title='Mi meteodologia' />
                  Aumentar masa muscula
                </li>
                <li className={animate ? 'five animate fadeIn' : 'two animate fadeOut'}>
                  <img className='item-img-tic' src={tic} alt='Mi metodologia' title='Mi meteodologia' />
                  Mejorar el rendimiento deportivo
                </li>
                <li className={animate ? 'six animate fadeIn' : 'two animate fadeOut'}>
                  <img className='item-img-tic' src={tic} alt='Mi metodologia' title='Mi meteodologia' />
